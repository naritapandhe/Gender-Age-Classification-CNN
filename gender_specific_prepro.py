...
def extract_gender_train_data(gen, fold_names, save_path):
	...
	for fold in fold_names:
		...
		#dict = {'fold_name': fold, 'images': inputimages, 'ages': ages}
...
def extract_gender_test_data(gen,fold_names,save_path):
	...
	for fold in fold_names:
		...
		#dict = {'fold_name': fold, 'images': inputimages, 'ages':ages, 'folder_names': folder_names, 'image_names':image_names,'face_ids':face_ids}
		#save_obj(dict,fold,save_path)


	print('Writing the testing data to a file....')		
	with open('testing_data'+ gen +'.json', 'w') as fout:
...
def main():
	...
	if (gender=='m'):
		...
		save_path = '/Volumes/Mac-B/faces-recognition/new_dicts/male/'
		...
		train_fold_names = ['fold_0_data','fold_1_data','fold_2_data','fold_3_data']
		save_path = '/Volumes/Mac-B/faces-recognition/new_dicts/female/'
