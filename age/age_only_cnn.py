...
pickle_file_path_prefix = '/home/ubuntu/gender_age/m/m/'
...
#X_train, X_val, y_train, y_val = cross_validation.train_test_split(X,y,train_size=0.1, stratify=y)
...
for i in range(num_steps):
    ...
    if (i % 1000 == 0):    
        ...
        save_path = saver.save(sess, "/home/ubuntu/gender_age/f/saved_model/model.ckpt")
