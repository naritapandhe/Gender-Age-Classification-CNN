		...
		for i in range(num_steps):
			...
			if (i % 1000 == 0):
				...
				if tacc > past_tacc:
					...
					np.savetxt('/media/narita/My Passport/Gender-Age Classification/subject_exclusive_distributed_data/female/saved_model3/predicted_females_age_prediction.txt',pred,fmt='%.0f') 
