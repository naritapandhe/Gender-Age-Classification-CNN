...
def create_crossval_data(fold_names):
	...
	for gender in genders:
		...
		for i in range(len(cv_train)):
			...
			save_pickle(train_data,gender+'_cv_train_'+str(i), '/media/narita/My Passport/Gender-Age Classification/subject_exclusive_distributed_data/male/')
			save_pickle(val_data,gender+'_cv_val_'+str(i), '/media/narita/My Passport/Gender-Age Classification/subject_exclusive_distributed_data/male/')
...
def main():
	male_subject_exclusive_folds = ['male_fold_0_data','male_fold_1_data','male_fold_2_data','male_fold_3_data']
	create_crossval_data(male_subject_exclusive_folds)
	#male_subject_exclusive_fold_prefix = '/home/narita/Documents/pythonworkspace/data-science-practicum/gender-age-classification/new_distributed_data_subject_exclusive/male/'
	#read_fold_and_images(male_subject_exclusive_folds,male_subject_exclusive_fold_prefix,'/home/narita/Documents/pythonworkspace/data-science-practicum/gender-age-classification/data/aligned/')
